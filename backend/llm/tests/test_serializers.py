...
class ThinkingLogSerializerTest(SimpleTestCase):
    ...
    def test_thinking_log_item_serializer_keeps_request_id_from_output_json(self):
        instance = SimpleNamespace(
            id=uuid4(),
            session_id=uuid4(),
        ...
        self.assertEqual(serializer.data["request_id"], "req-123")
    ...
    def test_thinking_log_item_serializer_does_not_classify_output_json_session_id_as_chat(self):
        ...
        self.assertEqual(serializer.data["request_id"], "req-456")
