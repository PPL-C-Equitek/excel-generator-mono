...
class ChatSessionSerializerTest(SimpleTestCase):
    ...
    def test_session_detail_serializer_includes_messages_and_outputs(self):
        ...
        self.assertEqual(
            serializer.data["generated_outputs"]["results"][0]["export_output_json"]["document_info"]["filename"],
            "example.xlsx",
        )
        self.assertEqual(
    ...
    def test_session_resume_serializer_includes_chat_history_and_thinking_logs(self):
        ...
        self.assertEqual(
            serializer.data["history"][1]["export_output_json"]["document_info"]["filename"],
            "example.xlsx",
        )
        self.assertEqual(
